      ...
      'actions': [
        {
          ...
          'action': [
                ...
                '--warning_level',
                'VERBOSE',
                "--js", "<@(curr_dir)/webinos/common/rpc/lib/webinos_rpc.js",
                "--js", "<@(curr_dir)/webinos/common/manager/messaging/lib/webinos_messagehandler.js",
                ...
                "--js", "<@(curr_dir)/webinos/common/rpc/lib/webinos_utils.js",
