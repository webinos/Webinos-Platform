...
//  This class represents the context objects that will be logged
        ...
        webinos.context.tapRpc = function () {
...
//        console.log(typeof _RPCHandler );
        if (typeof _RPCHandler == "function") webinos.context.tapRpc();
        else console.log('[ERROR] _RPCHandler is not accessible by Context Manager. It not possible to capture data.', 'yellow+black_bg');
