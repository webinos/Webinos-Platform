...
window.addEventListener("load", function(){evalEquals("document.defaultView.getComputedStyle(document.getElementById('test'),null).getPropertyValue('list-style-type')", "lower-alpha", "equal")}, false); 
