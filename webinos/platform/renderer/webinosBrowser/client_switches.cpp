...
// webinos attributes
const char kWebinosShowChrome[] = "webinos-show-chrome";
const char kWebinosSideLoad[] = "webinos-side-load";
const char kWebinosWidget[] = "webinos-widget";
const char kWebinosWidth[] = "webinos-width";
const char kWebinosHeight[] = "webinos-height";
