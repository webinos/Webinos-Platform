 ...
 * Copyright 2013 Martin Prins, TNO (adaptation of webinos.service_tv.mockup.js and webinos.service_tv.vlcdvb.js for screencasts)
 * 
 ******************************************************************************/
...
(function() {
	...
	TVTunerManager.prototype.getTVSources = function(successCallback,
		...
		try{
			readChannels = require(CHANNELS_CONF_FILE);
		}catch(e){		
console.log(CHANNELS_CONF_FILE+' '+readChannels);process.exit();
