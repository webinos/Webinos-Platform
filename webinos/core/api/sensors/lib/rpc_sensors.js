                ...
                switch(cmd) {
                    ...
                    case 'data':
                        ...
                        if(serviceList[id].listenerActive == true) {
                            ...
                            for(var i=0; i<serviceList[id].sensorEventListeners.length; i++){
                                if(serviceList[id].sensorEventListeners[i][3] === "sensor"){
                                    //console.log("RPC_sensor : send RPC "+ JSON.stringify(serviceList[id].listeners[i][2]));
                                    var rpc = rpcHandler.createRPC(serviceList[id].sensorEventListeners[i][2], "onEvent", sensorEvent);
