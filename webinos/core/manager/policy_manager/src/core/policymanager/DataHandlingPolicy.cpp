...
#include "DataHandlingPolicy.h"

DataHandlingPolicy::DataHandlingPolicy(TiXmlElement* dhpolicy){

	// PolicyId attribute
	//PolicyId = (dhpolicy->Attribute("PolicyId")!=NULL) ? dhpolicy->Attribute("PolicyId") : NULL;
	PolicyId = dhpolicy->Attribute("PolicyId");
