...
var PzpWSS = function() {
  ...
  function handleRequest(uri, req, res) {
       ...
       * webinos\core\manager\widget_manager\lib\ui\widgetServer.js
       */
  ...
  function autoEnrollment(query) {
    ...
    if(cmd === "authStatus") {
      ...
      msg = prepMsg(from, to, "authenticate", {"provider": value, "returnPath": "localhost:"+ ports.pzp_web_webSocket+"/testbed/client.html"});
