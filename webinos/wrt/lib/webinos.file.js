...
(function (exports) {
    ...
    Entry.prototype.toJSON = function () {
        return { name:this.name, fullPath:this.fullPath, filesystem:this.filesystem, isFile:this.isFile, isDirectory:this.isDirectory };
    };
    ...
    FileEntry.prototype.file = function (successCallback, errorCallback) {
        ...
        self.rpc.executeRPC(request, function (metadata) {
            ...
            var port = self.rpc.createRPC(self.service, "read",
                { entry:self, options:{ bufferSize:16 * 1024, autopause:true }
                });
