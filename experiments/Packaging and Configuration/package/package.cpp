...
class CpackageModule : public CAtlDllModuleT< CpackageModule >
{
public :
	DECLARE_LIBID(LIBID_packageLib)
#ifndef _CE_DCOM
	DECLARE_REGISTRY_APPID_RESOURCEID(IDR_PACKAGE, "{67E33314-2601-40DE-8164-1B32CBCB3C10}")
#endif
};

CpackageModule _AtlModule;
