...
namespace policyDB.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the Effect Entity. It will perform database oriented actions for
	/// a entity of type 'EffectEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class EffectDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public EffectDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "EffectEntity", new EffectEntityFactory())
		{
		}
		...
		internal EffectDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'EffectEntity' in a datatable which match the specified filter. 
