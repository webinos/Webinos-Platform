...
// Code is generated on: 04 March 2010 08:45:43
...
namespace policyDB.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the AttributeMatch Entity. It will perform database oriented actions for
	/// a entity of type 'AttributeMatchEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class AttributeMatchDAO : DaoBase
	{
		...
		internal AttributeMatchDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}
