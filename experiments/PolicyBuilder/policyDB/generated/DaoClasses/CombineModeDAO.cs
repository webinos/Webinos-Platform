...
namespace policyDB.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the CombineMode Entity. It will perform database oriented actions for
	/// a entity of type 'CombineModeEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class CombineModeDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public CombineModeDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "CombineModeEntity", new CombineModeEntityFactory())
		{
		}
		...
		internal CombineModeDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'CombineModeEntity' in a datatable which match the specified filter. 
		...
		/// <summary>
		/// Retrieves in the calling CombineModeCollection object all CombineModeEntity objects
		...
		public bool GetMultiUsingLibraryCollectionViaPolicy(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity libraryInstance, int pageNumber, int pageSize)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(policyDB.EntityType.CombineModeEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(CombineModeEntity.Relations.PolicyEntityUsingCombineModeId, "Policy_");
			relations.Add(PolicyEntity.Relations.LibraryEntityUsingLibraryId, "Policy_", string.Empty, JoinHint.None);
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiUsingLibraryCollectionViaPolicy(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity libraryInstance, IPrefetchPath prefetchPathToUse)
		{
			IEntityFields fieldsToReturn = EntityFieldsFactory.CreateEntityFieldsObject(policyDB.EntityType.CombineModeEntity);
			RelationCollection relations = new RelationCollection();
			relations.Add(CombineModeEntity.Relations.PolicyEntityUsingCombineModeId, "Policy_");
