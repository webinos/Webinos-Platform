...
namespace policyDB.DaoClasses
{
	...
	/// <summary>
	/// General DAO class for the Target Entity. It will perform database oriented actions for
	/// a entity of type 'TargetEntity'. This DAO works on an EntityFields object. 
	/// </summary>
	public partial class TargetDAO : DaoBase
	{
		/// <summary>CTor</summary>
		public TargetDAO() : base(InheritanceInfoProviderSingleton.GetInstance(), new DynamicQueryEngine(), InheritanceHierarchyType.None, "TargetEntity", new TargetEntityFactory())
		{
		}
		...
		internal TargetDAO(IInheritanceInfoProvider inheritanceInfoProviderToUse, DynamicQueryEngineBase dqeToUse, InheritanceHierarchyType typeOfInheritance, string entityName, IEntityFactory entityFactory) : base(inheritanceInfoProviderToUse, dqeToUse, typeOfInheritance, entityName, entityFactory)
		{
		}


		/// <summary>
		/// Retrieves entities of the type 'TargetEntity' in a datatable which match the specified filter. 
		...
		public bool GetMultiUsingCombineModeCollectionViaPolicy(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IEntity combineModeInstance, int pageNumber, int pageSize)
		{
			...
			relations.Add(TargetEntity.Relations.PolicyEntityUsingTargetId, "Policy_");
